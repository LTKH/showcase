                ...
                $.map(this, function(el, idx) {
                    ...
                    x.cbcs = {
                            ...
                            try {
                                ...
                                var result2 = function() {
                                    try {
                                        ...
                                        try {
                                            (x.callbacks && x.callbacks.click) && x.callbacks.click(elem); } catch (e) { alert(e); }
                        ...
                        mouseover: function(evt) {
                            ...
                            try {
                                (x.callbacks && x.callbacks.mouseover) && x.callbacks.mouseover(elem); } catch (e) { alert(e); }
                        },
                        mouseout: function(evt) {
                            var elem = evt.data.leaf;
                            $(elem.elem.heading).removeClass(x.classes.hover);
                            try {
                                (x.callbacks && x.callbacks.mouseout) && x.callbacks.mouseout(elem); } catch (e) { alert(e); }
                        }
                    };
                        ...
                        try {
                            if ($.cookie && x.saveState && leafObj) {
                                ...
                                if (cook.length > 0) {
                                    ...
                                    if (ret) { if (inarr === (-1)) { return false; } else { return true; } } else {
                                        if (inarr === (-1)) {
                    ...
                    var makeLeaf = function(preObj, parent) {
                        try {
                            ...
                            if (obj.obj.open) { gsCook(obj); } else { obj.obj.open = gsCook(obj, true); }
                            return obj;
